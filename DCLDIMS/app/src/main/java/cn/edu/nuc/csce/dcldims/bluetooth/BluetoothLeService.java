...
public class BluetoothLeService extends Service {
    private final static String TAG = "cn.edu.nuc.csce.DCLDIMS";
    ...
    private boolean bForMonitorData = false;
    ...
    public final static String ACTION_DATA_AVAILABLE_FOR_MONITOR=
            "com.example.bluetooth.le.ACTION_DATA_AVAILABLE_FOR_ADJUSTING";
    public final static String EXTRA_DATA =
            "com.example.bluetooth.le.EXTRA_DATA";


    public final static UUID UUID_JIAN_CE_XI_TONG =
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                Log.i(TAG,"Services:" + gatt.discoverServices());
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Log.i(TAG,"Readed data:"+characteristic.getValue().toString());
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            //if (characteristic != null) {
                ...
                //String s = bytesToString(characteristic.getValue());
                //Log.i(TAG,s);
            //}
            //Log.i(TAG,"In Service,Data Length:" + characteristic.getValue().length);
            if(bForMonitorData){
                broadcastUpdate(ACTION_DATA_AVAILABLE_FOR_MONITOR,characteristic);
                //bForMonitorData = false;
            }else {
                broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            }
        }
    ...
    public boolean initialize() {
        ...
        if (mBluetoothManager == null) {
            ...
            Log.i(TAG,"Obtain BluetoothManager success!");
        }
        ...
        Log.i(TAG,"Obtain BluetoothAdapter success!");
    ...
    public void writeData(byte[] data,Boolean bForMonitor) {
        bForMonitorData = bForMonitor;//是否是发送给监控广播接收器的数据标志
        if (mBluetoothGatt != null) {
            if (mBluetoothGatt.connect() && mCharacteristic != null &&
                    data != null) {
                if(!(mCharacteristic.setValue(data))){
                    Log.i(TAG,"=======mCharacteristic set Value error!");
                }
    ...
    public void test(){
        Log.i(TAG,"========Call service's test() function!");
    }
}
