 ...
 */
public class Pianlijiao2View extends View {

    private int VIEW_WIDTH;
    private double pianli_dushu=0;

    public Pianlijiao2View(Context context){
        super(context);
    }
    public Pianlijiao2View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public Pianlijiao2View(Context context, AttributeSet attrs, int defStyle){
...
//        canvas.drawArc(rectf, 0, 60, true, paint);
        ...
        super.onDraw(canvas);
        System.out.println("2偏离角初始绘图");
    }

    @Override
    public void postInvalidate() {
        super.postInvalidate();
        System.out.println("2偏离角重绘");
    }
