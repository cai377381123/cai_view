 ...
 * 变长为21.21
 */
public class Pianlifangwei2View extends View {
    private int VIEW_WIDTH;
    private float zhishiqi_x=10.605f;
    private float zhishiqi_y=10.605f;
    private int multiple=10; //设置缩放倍数


    public Pianlifangwei2View(Context context){
        super(context);
    }
    public Pianlifangwei2View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public Pianlifangwei2View(Context context, AttributeSet attrs, int defStyle){
